...
│   ├── Arabidopsis_thaliana.TAIR10.dna.bgz
│   ├── Oryza_sativa.IRGSP-1.0.dna.bgz
│   ├── Triticum_aestivum.IWGSC.dna.bgz
│   ├── Solanum_lycopersicum_gca000188115v5cm.SL4.0.dna.bgz
│   ├── Daucus_carota.ASM162521v1.dna.bgz
│   ├── Helianthus_annuus.HanXRQr2.0-SUNRISE.dna.bgz
│   ├── Alopecurus_myosuroides_v1.bgz
│   ├── Amaranthus_palmeri_hap1_v01.bgz
│   ├── Artemisia_annua_v1.bgz
│   ├── Cryptomeria_japonica_1.0.bgz
│   ├── Nicotiana_benthamiana_v1.bgz
│   ├── Tragopogon_porrifolius_hap1.1.bgz
│   ├── Beta_vulgaris.RefBeet-1.2.2.dna.bgz
│   ├── Lycium_ruthenicum_ASM4143038v1.bgz
│   └── Cynodon_dactylon_ASM4686236v1.bgz
├── GENE/                            # 基因注释文件（可选）
...
| Genome名称 | FASTA文件 | 物种 |
|------------|-----------|------|
| Arabidopsis_thaliana | Arabidopsis_thaliana.TAIR10.dna.bgz | 拟南芥 |
| Oryza_sativa | Oryza_sativa.IRGSP-1.0.dna.bgz | 水稻 |
| Triticum_aestivum | Triticum_aestivum.IWGSC.dna.bgz | 小麦 |
| Solanum_lycopersicum | Solanum_lycopersicum_gca000188115v5cm.SL4.0.dna.bgz | 番茄 |
| Daucus_carota | Daucus_carota.ASM162521v1.dna.bgz | 胡萝卜 |
| Helianthus_annuus | Helianthus_annuus.HanXRQr2.0-SUNRISE.dna.bgz | 向日葵 |
| Alopecurus_myosuroides | Alopecurus_myosuroides_v1.bgz | 黑麦草 |
| Amaranthus_palmeri | Amaranthus_palmeri_hap1_v01.bgz | 苋 |
| Artemisia_annua | Artemisia_annua_v1.bgz | 青蒿 |
| Cryptomeria_japonica | Cryptomeria_japonica_1.0.bgz | 日本柳杉 |
| Nicotiana_benthamiana | Nicotiana_benthamiana_v1.bgz | 本氏烟草 |
| Tragopogon_porrifolius | Tragopogon_porrifolius_hap1.1.bgz | 婆罗门参 |
| Beta_vulgaris | Beta_vulgaris.RefBeet-1.2.2.dna.bgz | 甜菜 |
| Lycium_ruthenicum | Lycium_ruthenicum_ASM4143038v1.bgz | 黑果枸杞 |
| Cynodon_dactylon | Cynodon_dactylon_ASM4686236v1.bgz | 狗牙根 |
...
nextflow run main.nf \
    ...
    -profile server \
    -with-report /data1/users/siyangming/eccDNA_results/reports/Amaranthus_palmeri_report.html \
    -with-timeline /data1/users/siyangming/eccDNA_results/reports/Amaranthus_palmeri_timeline.html \
    -with-trace /data1/users/siyangming/eccDNA_results/reports/Amaranthus_palmeri_trace.txt
```

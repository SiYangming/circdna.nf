process AMPLICONSUITE {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/ampliconsuite:1.6.0--pyh109da93_0' :
        'quay.io/biocontainers/ampliconsuite:1.6.0--pyh109da93_0' }"
